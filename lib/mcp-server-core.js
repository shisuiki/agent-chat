...
// 6. accept_task — sugar for transition created → accepted
server.tool(
  'accept_task',
...
// 7. transition_task — drive a task through the state machine
server.tool(
  'transition_task',
...
// 8. comment_task — append a comment to a task
server.tool(
  'comment_task',
...
// 9. update_task_execution — self-report heartbeat or waiting metadata mid-flight
server.tool(
